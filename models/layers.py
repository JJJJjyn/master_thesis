...
class CVAE(nn.Module):
    ...
    def __init__(self, image_size, label_size, latent_size):
        super(CVAE, self).__init__()

        self.fc1 = nn.Linear(image_size * image_size + label_size, 200)
        self.fc2_mu = nn.Linear(200, latent_size)
        self.fc2_log_std = nn.Linear(200, latent_size)
        self.fc3 = nn.Linear(286, 200)
        self.fc4 = nn.Linear(200, image_size * image_size)
